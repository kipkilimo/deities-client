import{P as u}from"./index-6b729fcd.js";import{g as i,c as a}from"./apolloClient-3b54e56b.js";u("alerts",{state:()=>({alertMessage:"",alertType:""}),actions:{setAlert(e,t){this.alertMessage=e,this.alertType=t}}});const y=u("resource",{state:()=>({prediction:"",surveyLikertQuestion:"What is your take on NEMBio, 'The Hub for Interactive Life Sciences Research Tools.', after the introduction given?",surveyLikertOptions:[{label:"Waste of time"},{label:"Neutral"},{label:"Needs radical surgery"},{label:"Just minor modifications and it is good to go - These are my suggestions (write on provided paper)."},{label:"Excellent proposition. Can't wait to try it!"}],exams:"",exam:"",tasks:"",task:"",resource:{},resourceIsComputing:!1,resources:[],filteredResources:[],sortBy:"title",filterByType:"",showAddResourceCoverAndContentDialog:!1,showCreateResourceDialog:!1,showExamsDialog:!1,showAssignmentsDialog:!1}),actions:{setQuestion(e){this.surveyLikertQuestion=e},setOptions(e){this.surveyLikertOptions=e},setResources(e){this.resources=e,this.filteredResources=e},setResource(e){this.resource=e},sortResources(){this.filteredResources.sort((e,t)=>e[this.sortBy]<t[this.sortBy]?-1:e[this.sortBy]>t[this.sortBy]?1:0)},filterResources(){this.filterByType?this.filteredResources=this.resources.filter(e=>e.contentType===this.filterByType):this.filteredResources=this.resources,this.sortResources()},async getAllTestResources(e){var r;const t=i`
      ...
      `;try{const r=(await a.query({query:e})).data.getAllResources;if(r)this.resources=r;else throw new Error("Failed to fetch resources")}catch(t){console.error("Error fetching resources:",t)}},async getAllMockExams(e){const t=i`
      ...
      `;try{const s=(await a.query({query:t,variables:{resourceType:e}})).data.getAllMockExams;if(s)this.exams=JSON.stringify(s);else throw new Error("Failed to fetch resource")}catch(r){console.error("Error fetching resource:",r)}},async getAllSpecificTypeResources(e){const t=i`
        query ($resourceType: String!) {
      ...
      `;try{const s=(await a.query({query:t,variables:{resourceType:e}})).data.getAllSpecificTypeResources;this.resources=s}catch(r){console.error("Error fetching resources:",r)}},async getUserTasks(e){const t=i`
        query ($userId: String!) {
      ...
      `;try{const s=(await a.query({query:t,variables:{userId:e}})).data.getPublisherLatestTasks;if(s)this.tasks=JSON.stringify(s),this.showAssignmentsDialog=!0;else throw new Error("Failed to fetch resource")}catch(r){console.error("Error fetching resource:",r)}},async getCurrentExam(e,t){const r=i`
      ...
      `;try{const o=(await a.query({query:r,variables:{sessionId:e,examType:t}})).data.getCurrentExam;if(o)this.exam=JSON.stringify(o);else throw new Error("Failed to fetch resource")}catch(s){console.error("Error fetching resource:",s)}},setCurrentExam(e){this.exam=JSON.stringify(e)},setCurrentExams(e){this.exams=JSON.stringify(e)},async getPublisherLatestExams(e){const t=i`
        query ($userId: String!) {

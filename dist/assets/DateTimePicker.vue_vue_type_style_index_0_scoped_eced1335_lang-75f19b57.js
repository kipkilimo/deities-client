import{P as c}from"./index-29b1d87f.js";import{g as o,c as i}from"./apolloClient-3b54e56b.js";const u=c("paper",{state:()=>({paper:{},papers:[],showCreatePaper:!1,filteredPapers:[],sortBy:"name",filterByLocality:""}),actions:{async getMostRecentPapers(r){var s;const t=o`
        query ($userId: ID!) {

    ...
    <v-row>
      ...
      >
        <v-card
          ...
          outlined
          @click="goToResourceRenderer"
        >
          <v-card-title color="#8fc0c5" class="d-flex align-center justify-space-between">
            <span class="resource-icon">{{ resource.icon }}</span>
            <span class="resource-name">
              {{ resource.name }} ({{ resource.resourceCount }})<v-card-text class="text-h11">
            {{ resource.type }}
          </v-card-text>
            </span>
          </v-card-title>

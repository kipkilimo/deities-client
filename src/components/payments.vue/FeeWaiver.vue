  ...
  <div>
    ...
    >
      ...
      <div class="text-subtitle-1 ma-1 mb-1 text-medium-emphasis">
        NEMBio Publication Credits Waiver Request
      </div>
      ...
      <v-form v-model="isFormValid" lazy-validation>
        <v-row>
          <v-col cols="12" sm="12">
            ...
            <v-text-field
              density="compact"
              placeholder="Enter discussion group ID"
              label="Discussion group ID"
            ...
            <v-card class="mb-12" color="surface-variant" variant="tonal">
              ...
              >
                This process will initiate annual NEMBio Publication Credits Fee Waiver
                request.
                <p>
            ...
            <v-btn
              ...
              color="#2c9933"
              size="large"
              :disabled="dgId.length !== 12 || isLoading"
              :loading="isLoading"

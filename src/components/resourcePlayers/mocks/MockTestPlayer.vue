                  ...
                  <v-card flat>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn
                        ...
                        @click="
                          saveAnswer(SCQAnswers, 'SCQ'), (scqSaved = true)
                        "
                      >
                        {{
                  ...
                  <v-card flat>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn
                        ...
                        "
                        @click="
                          saveAnswer(MCQAnswers, 'MCQ'), (mcqSaved = true)
                        "
                  ...
                  <v-card flat>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn
                        ...
                        @click="
                          saveAnswer(ATFAnswers, 'ATF'), (atfSaved = true)
                        "
                      >
                        {{
            ...
            <v-tooltip location="top">
              <template v-slot:activator="{ props }">
                <v-btn
                  ...
                  :disabled="!isFormValid"
                  @click="
                    saveAnswer(saqTypedResponse, 'SAQ'), (saqSaved = true)
                  "
            ...
            <v-tooltip location="top">
              <template v-slot:activator="{ props }">
                <v-btn
                  ...
                  :disabled="!isFormValid"
                  @click="
                    saveAnswer(leqTypedResponse, 'LEQ'), (leqSaved = true)
                  "
...
const currentExamDetails = ref(null); // JSON.parse(resourceStore.exam);
const examMetaInfo = ref(null); // currentExamDetails.examMetaInfo;
const numberOfQuestions = ref(null); // examMetaInfo.numberOfQuestions;
//
onBeforeMount(async () => {
  // const sessionIdRaw = JSON.parse(resourceStore.exam);
  //
  loading.value = true;
  const sessionId = localStorage.getItem("currentExamId");

  await resourceStore.getCurrentExam(sessionId, "MOCK");
  currentExamDetails.value = JSON.parse(resourceStore.exam);
  examMetaInfo.value = currentExamDetails.value.examMetaInfo;
  numberOfQuestions.value = examMetaInfo.value.numberOfQuestions;
...
const initializeQuestions = () => {
  ...
  for (let i = 0; i < Number(numberOfQuestions.value.SCQ); i++) {
  ...
  for (let i = 0; i < Number(numberOfQuestions.value.MCQ); i++) {
  ...
  for (let i = 0; i < Number(numberOfQuestions.value.ATF); i++) {
  ...
  for (let i = 0; i < Number(numberOfQuestions.value.ETF); i++) {

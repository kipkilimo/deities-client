    ...
    <!-- Inner carousel wrapper -->
      ...
      <!-- Inner card with audio player -->
        ...
        <video-player
          ...
          :volume="0.67"
          :autoplay="true" 
          style="height:69vh;min-width:100%;"
          @ended="next"
        /> 
...
const podcastBg = ref(
  "https://videosolutions.pro/wp-content/uploads/2023/08/play-button-background-video-solutions.svg"
);
const updateSlide = () => {
...
.carousel-background {
  background-image: url("https://videosolutions.pro/wp-content/uploads/2023/08/play-button-background-video-solutions.svg");

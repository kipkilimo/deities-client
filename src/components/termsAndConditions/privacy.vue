<template>
  <div class="ma-2 ml-2">
    ...
    <p>
      Our Services may be purchased by providers of educational services, such
      as schools, universities, education authorities, teachers, tutors, etc.
      (collectively referred to as “Organizations” in this Policy). Our Services
      may also be purchased by individuals such as students (collectively
    ...
    <p>
      ...
      outside Kenya. and by following these Privacy Principles:
    </p>
    <ul>
    ...
    <p>
      ...
      general, we do not use such data for any purpose other than improving and
      providing our Services to the User. Our collection, use, and sharing of
      User Data is governed by our contracts with the Organization or Individual
      that has purchased our Services.
    </p>
    ...
    <ul>
      ...
      <li>
        In some instances, for Services used by Organizations, other data may be
        collected, for example, when a school is using our admissions system.
        Please consult your Organization for more details.
      </li>
    </ul>
    <p>
    ...
    <ul>
      <li>
        You or your Organization share your information with us by registering
        with us or using our Services,
      </li>
      <li>You contact us via either electronic or non-electronic methods,</li>
      <li>
        You open emails from us or interact with our website, mobile apps, or
        other Services. This information is collected through cookies. Please
        read our cookie policy for more information.
      </li>
    </ul>
    <p>
      We use Google Analytics to collect, monitor, and analyze information.
      Google has its own privacy policy, which can be found at
      <a href="https://policies.google.com/privacy" target="_blank"
        >https://policies.google.com/privacy</a
      >.
    </p>
    <p>
      We use Adjust, a mobile app analytics and marketing software. Their
      privacy policy can be found at
      <a href="https://www.adjust.com/terms/privacy-policy/" target="_blank"
        >https://www.adjust.com/terms/privacy-policy/</a
      >.
    </p>
    <p>
      We also use META Services (such as advertising and social login). Their
      privacy policy can be found at
      <a href="https://web.facebook.com/about/privacy/" target="_blank"
        >https://web.facebook.com/about/privacy/</a
      >.
    </p>
    ...
    <p>
      ...
      to have your account deleted. In such an event, we will provide notice
      before personal information is transferred and becomes subject to a
      different privacy policy.
    </p>
    <p>
      We use anonymized aggregated data to analyze how our Users interact with
      our Services in order to improve them and come up with new Services. When
      we do this, we ensure that all direct identifiers to any person are
      removed, meaning the data is no longer considered personalized for the
    ...
    <ul>
      ...
      <li>
        To comply with our legal obligations (such as if we are obligated to
        report, share, or archive personal information in a specific way),
      </li>
      <li>
        For a range of business purposes that are in our legitimate interests as
        a commercial provider of educational Services,
      </li>
      <li>
        With your consent (such as when we specifically ask you to consent to
        the use of your User Data in a particular way).
      </li>
    </ul>
    <p>
    ...
    <p>
      Securing your User Data is very important to us. We take appropriate
      security measures to protect against unauthorized access and to verify
      your identity before granting your account access or making corrections to
      your information.
    </p>
    <p>
      We advise you to create and maintain a strong password to help ensure the
      security of your account and to never share it with others. We also urge
      you to only use our Services via secure networks and to maintain
    ...
    <p>
      ...
      accessible through the Services, or collect User Data either manually or
      in a semi-automated or automated manner.
    </p>
    <p>
      If we become aware that any Individual or Organization (including its
      Users) are in violation of this Privacy Policy or our Terms and
      Conditions, we may immediately terminate, without notice, the Individual
    ...
    <p>
      We provide our Services internationally. In accordance with Under the
      Regulations, civil registration registries cannot transfer personal data
      collected for civil registration purposes outside Kenya without the
      written approval of the DPC. The Data Protection (General) Regulations,
      2021 elaborate in more detail transfer of personal data outside Kenya.
      requirements, all service providers are audited to check that they comply
      with Under the Regulations, civil registration registries cannot transfer
      personal data collected for civil registration purposes outside Kenya
      without the written approval of the DPC. The Data Protection (General)
      Regulations, 2021 elaborate in more detail transfer of personal data
    ...
    <p>
      To deliver the Service, we use a number of third-party data processors
      that are contractually committed to delivering the Privacy Policy
      described in this document.
    </p>
    <p>
      Your information, including personalized User Data, may be transferred to
      (and maintained on) computers located outside of your state, province, or
      other governmental jurisdiction where the data protection laws may differ
      from those of your jurisdiction. This includes areas outside of the
      European Union. To ensure Under the Regulations, civil registration
    ...
    <p>
      In the event that a dispute arises with regard to the international
    ...
    <p>
      We provide Services that may be aimed at Users under the age of 18. We
      take the utmost care to only request the information necessary to provide
      our Services from these Users.
    </p>
    <p>
      If you are under the age of 18 and have any questions regarding your User
      Data and how it is used by our Services, we recommend you contact your
      parent or legal guardian, or the Organization through which your access to
      our Services has been set up.
    </p>

    <h2>What Rights Do I Have Regarding My User Data?</h2>
    <p>
      You may have rights in certain regions, such as the European Economic
      Area, in relation to your User Data. This includes the right to update and
      correct your personal information, obtain a copy of your data upon
      request, and erasure of your data if it is no longer essential for us to
      retain it in order to fulfill the purposes for which it was collected. You
      may also request to restrict the processing of your data, in which case we
    ...
    <p>
      From time to time we may make changes to this Privacy Policy. We will
